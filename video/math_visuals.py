...
def _water(solution: MathSolution) -> list[VideoElement]:
    return [
        VideoElement(type="tank", semantic_key="unit", text="满池水 = 1", x=0.5, y=0.42, start=4, end=9, animation="draw"),
...
def _rectangle(solution: MathSolution) -> list[VideoElement]:
    ...
    return [
        VideoElement(type="shape", semantic_key="shape", text="长方形", x=0.5, y=0.42, scale=1.3, start=4, end=10, animation="draw"),
        VideoElement(type="dimension", semantic_key="length", text="长", x=0.78, y=0.42, start=6, end=10, animation="draw"),
        VideoElement(type="dimension", semantic_key="width", text="宽", x=0.5, y=0.59, start=7, end=11, animation="draw"),
        VideoElement(type="relation", semantic_key="formula", text="面积 = 长 × 宽" if "面积" in target else "周长 = (长 + 宽) × 2", x=0.5, y=0.58, scale=0.95, start=8, end=13, animation="fade"),
        VideoElement(type="formula", semantic_key="result", text=solution.steps[0], x=0.5, y=0.70, scale=0.88, start=12, end=18, animation="fade"),
    ]
...
def _fraction(solution: MathSolution) -> list[VideoElement]:
    ...
    return [
        VideoElement(type="fraction_bar", semantic_key="original", text="分数模型", x=0.5, y=0.45, start=4, end=9, animation="draw"),
        VideoElement(type="relation", semantic_key="operation", text=step, x=0.5, y=0.68, scale=0.9, start=9, end=15, animation="fade"),
        VideoElement(type="formula", semantic_key="result", text=f"结果：{solution.answer}", x=0.5, y=0.80, scale=0.9, start=14, end=18, animation="pop"),
    ]
